...
#def run_method(task, task_type, gpu_ids, model_names, hyperparameters, prompts, steers, experiment_name):
    ...
    # Evaluate
    test_scores_1 = load_reward_model_and_score(test_input_list, final_outputs1, gpu_id=experiment_name)
    test_scores_2 = load_reward_model_and_score(test_input_list, final_outputs2, gpu_id=experiment_name)
